import { u as useNavigate, j as jsxRuntimeExports, U as Users, G as GitBranch, B as Button, T as Target, D as DollarSign, m as motion, S as SquareCheckBig, a as TrendingUp } from "./index-CgV9Taym.js";
            ...
            ChartCard,
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-4 pt-3 border-t border-border", children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-1.5", children: recentActivity.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-2 py-1", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      item.icon,
                      {
      ...
      motion.div,
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          ChartCard,
          {
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 sm:grid-cols-4 gap-3", children: [
              {
              ...
              "div",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(item.icon, { className: `w-5 h-5 mb-2 ${item.color}` }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-lg sm:text-xl font-display font-bold text-foreground", children: item.value }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-[11px] text-muted-foreground mt-0.5 leading-tight", children: item.label })
                ]
              },
              item.label
            )) })
