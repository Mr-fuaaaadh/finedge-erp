import { b as createLucideIcon, u as useAuth, T as Target, j as jsxRuntimeExports, m as motion, d as TrendingUp, C as Clock } from "./index-BjKYYUic.js";
import { P as Progress } from "./progress-BTvPlCHB.js";
...
function StaffDashboard() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      ...
      motion.div,
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-4", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { className: "text-lg font-display font-bold text-foreground", children: [
              "Good ",
              greeting,
              ", ",
              user.name.split(" ")[0],
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-2 gap-3 sm:gap-4 mb-4 sm:mb-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        motion.div,
        {
        ...
        motion.div,
        {
          ...
          children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            ChartCard,
            {
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-1", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full text-xs", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("thead", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { className: "border-b border-border", children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "text-left py-2 px-1 font-semibold text-muted-foreground", children: "Company" }),
                  ...
                  recentLeads.map((lead, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "tr",
                    {
                      ...
                      children: [
                        ...
                        /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "py-2.5 px-1 text-muted-foreground truncate max-w-[80px]", children: lead.company }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-2 gap-3 sm:gap-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        motion.div,
        {
          initial: { opacity: 0, y: 12 },
