import { b as createLucideIcon, r as reactExports, t as useComposedRefs, w as useDirection, j as jsxRuntimeExports, s as Primitive, E as Presence, y as createContextScope, q as composeEventHandlers, F as useCallbackRef, H as useLayoutEffect2, f as cn, p as useControllableState, x as useSize, n as Check, i as Search, I as ChevronDown, B as Button, k as ChevronLeft, l as ChevronRight } from "./index--w3DYRFQ.js";
import { e as clamp, u as usePrevious, I as Input, C as ChevronUp } from "./select-Bi2YwvFw.js";
import { a as Skeleton } from "./StatCard-Dmm7jm2H.js";
import { E as EmptyState } from "./ModalForm-BfCynOlA.js";
/**
...
function DataTable({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { "data-ocid": dataOcid, className: "space-y-3", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rounded-2xl border border-border overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-x-auto w-full scrollbar-thin", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full text-sm", style: { minWidth: "500px" }, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("thead", { className: "bg-muted/30 border-b border-border", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { children: [
        showSelectable && /* @__PURE__ */ jsxRuntimeExports.jsx("th", { className: "px-2 sm:px-3 py-3 w-10", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          Checkbox,
          {
            checked: allPageSelected,
            "data-state": somePageSelected && !allPageSelected ? "indeterminate" : void 0,
        ...
        columns.map((col) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          "th",
          {
            ...
            "aria-sort": sortKey === String(col.key) ? sortDir === "asc" ? "ascending" : "descending" : void 0,
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { className: "divide-y divide-border", children: pageData.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx("tr", { children: /* @__PURE__ */ jsxRuntimeExports.jsx("td", { colSpan: columns.length + (showSelectable ? 1 : 0), children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        EmptyState,
        {
        ...
        return /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "tr",
          {
            ...
            children: [
              showSelectable && /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-2 sm:px-3 py-2 sm:py-3 w-10", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                Checkbox,
                {
                  checked: isSelected,
