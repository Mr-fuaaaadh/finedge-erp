import { b as createLucideIcon, r as reactExports, j as jsxRuntimeExports, B as Button, C as Clock, U as Users, m as motion, a as mockUsers, Z as ue } from "./index-BjKYYUic.js";
import { L as Label, D as Dialog, b as DialogContent, c as DialogHeader, d as DialogTitle } from "./dialog-u123pluM.js";
...
import { A as Activity } from "./activity-BmY95pcv.js";
import { R as ResponsiveContainer, C as CartesianGrid, X as XAxis, Y as YAxis, T as Tooltip, B as Bar } from "./generateCategoricalChart-D2GE3Quo.js";
...
function AttendancePage() {
  ...
  const dailyRecords = mockAttendance.filter((a) => a.date === selectedDate).filter(
    (a) => branchFilter === "All Branches" || branchMap[a.branchId] === branchFilter
  ).filter(
    (a) => statusFilter === "All Statuses" || a.status === statusFilter
  );
  const lateEntries = mockAttendance.filter((a) => a.date === selectedDate && a.status === "Late").map((a) => ({
    ...a,
    minutesLate: 45
  }));
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-3 sm:gap-4 mb-4 sm:mb-6", children: [
      {
        title: "Present Today",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Tabs, { value: activeTab, onValueChange: setActiveTab, children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(TabsContent, { value: "daily", className: "space-y-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-card border border-border rounded-2xl shadow-card p-3 sm:p-4 flex flex-wrap items-end gap-2 sm:gap-3", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-1", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-xs text-muted-foreground", children: "Branch" }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xs text-muted-foreground ml-auto self-end pb-1", children: [
            dailyRecords.length,
            " records"
          ] })
        ] }),
        ...
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-5", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground", children: "— hover a day to see absences" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(CalendarHeatmap, {})
          ]
        }
      ) }),
