import { e as createLucideIcon, a as TrendingUp, D as DollarSign, j as jsxRuntimeExports, B as Button, m as motion } from "./index-CgV9Taym.js";
import { C as ChartCard } from "./ChartCard-DfiZ9ngf.js";
import { P as PageHeader } from "./PageHeader-CHVHFP_Q.js";
import { T as TrendingDown, S as StatCard } from "./StatCard-DkWGxI9F.js";
...
import { R as ResponsiveContainer, C as CartesianGrid, X as XAxis, Y as YAxis, T as Tooltip, L as Legend, B as Bar, a as Cell } from "./generateCategoricalChart-BdurIGga.js";
import { A as AreaChart, a as Area } from "./AreaChart-BvtTBl9w.js";
import { A as ArrowUpRight, a as ArrowDownRight } from "./arrow-up-right-QcfsABzT.js";
import { B as BarChart } from "./BarChart-U3L8K1-a.js";
import { P as PieChart, a as Pie } from "./PieChart-Cfyalh1f.js";
import { L as LineChart, a as Line } from "./LineChart-EMOqZBna.js";
      ...
      motion.div,
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          ChartCard,
          {
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { width: "100%", height: 300, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
              AreaChart,
              {
                data: plData,
          ...
          ChartCard,
          {
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-x-auto mt-1 -mx-1", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full text-xs min-w-[520px]", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { children: branchTable.map((branch, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "tr",
                {
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "py-3 px-2 text-right font-semibold text-foreground", children: formatCompact(branch.totalRevenue) }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "py-3 px-2 text-right text-muted-foreground hidden sm:table-cell", children: formatCompact(branch.totalExpenses) }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "py-3 px-2 text-right font-semibold text-green-600 dark:text-green-400", children: formatCompact(branch.totalProfit) }),
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("tfoot", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { className: "border-t-2 border-border bg-muted/20", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "py-2.5 px-2 text-right font-bold text-foreground", children: formatCompact(totalRevenue) }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "py-2.5 px-2 text-right font-bold text-muted-foreground hidden sm:table-cell", children: formatCompact(totalExpenses) }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "py-2.5 px-2 text-right font-bold text-green-600 dark:text-green-400", children: formatCompact(netProfit) }),
                ...
                BarChart,
                {
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      Tooltip,
                      {
                        formatter: (v) => [formatCompact(v), "Disbursed"],
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-2 mt-3 pt-3 border-t border-border", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center p-2 rounded-xl bg-muted/40", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-display font-bold text-foreground", children: formatCompact(loanPortfolio) }),
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center p-2 rounded-xl bg-primary/5", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-display font-bold text-green-700 dark:text-green-400", children: formatCompact(loanPortfolio * 0.82) }),
