import { b as createLucideIcon, j as jsxRuntimeExports, X, f as cn, U as Users, m as motion, r as reactExports, B as Button, d as TrendingUp, h as Building2, o as Badge } from "./index--w3DYRFQ.js";
...
import { R as Root, C as Content, a as Close, T as Title, P as Portal, O as Overlay, L as Label } from "./dialog-BKDxYpuf.js";
import { L as LayoutGrid, D as DataTable, T as Textarea, S as ScrollArea, U as User } from "./DataTable-CA0kKoEt.js";
import { T as Tabs, a as TabsList, b as TabsTrigger, c as TabsContent } from "./tabs-C-giT0DG.js";
import { P as Plus, M as ModalForm } from "./ModalForm-BfCynOlA.js";
...
import { F as FileText } from "./file-text-Cc5q7MuF.js";
...
import { R as ResponsiveContainer, a as Cell, T as Tooltip, C as CartesianGrid, X as XAxis, Y as YAxis, L as Legend, B as Bar } from "./generateCategoricalChart-CVvru8ED.js";
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between gap-2 mb-2", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            PriorityBadge,
            {
              priority: lead.value >= 1e6 ? "High" : lead.value >= 5e5 ? "Medium" : "Low"
            }
          )
        ] }),
        ...
        lead.followUpDate && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-2 pt-2 border-t border-border flex items-center gap-1 text-[10px] text-muted-foreground", children: [
...
function LeadDetailSheet({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(Sheet, { open, onOpenChange: (v) => !v && onClose(), children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
    SheetContent,
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(SheetHeader, { className: "px-6 py-5 border-b bg-card", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between gap-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
...
function LeadsPage() {
  ...
  const openLead = reactExports.useCallback((lead) => {
  ...
  const columns = reactExports.useMemo(() => buildColumns(openLead), [openLead]);
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 sm:grid-cols-2 gap-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs(Select, { children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(SelectContent, { children: SOURCE_LABELS.map((s) => /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: s, children: s }, s)) })
              ] })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-1.5", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { className: "text-xs", children: "Loan Value (₹)" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                Input,
                {
                  type: "number",
